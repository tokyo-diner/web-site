...
export const recruitPaths = (): string[] =>
  _recruitPaths.map((d) => '/assets' + d);
export const shukugawaPaths = (): string[] =>
  _shukugawaPaths.map((d) => '/assets' + d);
export const takarazukaPaths = (): string[] =>
  _takarazukaPaths.map((d) => '/assets' + d);
