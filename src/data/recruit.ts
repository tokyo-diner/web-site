  ...
  recruit: [
    {
      ...
      items: [
        ...
        {
          key: '応募方法',
          value: 'お電話または上記メールフォームからご連絡ください。',
        },
      ],
    },
    {
      ...
      items: [
        ...
        { key: '勤務地', value: '夙川本店 / 宝塚店 to table' },
        {
          key: '給与',
          value:
            '月給 215,000円から（チーフ/25万円～30万円  店長/30万円～40万円）',
        },
        {
          key: '休日',
          value:
            '月7回　定休日月曜、火曜 (月に一度、焼き菓子の製造やイベント、教室、見学会などの研修あり)',
        },
        { key: '勤務時間', value: '時間：6:00～16:30　※シフト制　※休憩あり' },
        {
          key: '待遇',
          value:
            '各種社会保険完備、役職手当、残業手当、交通費全額支給、制服貸与、社員割引',
        },
        {
          key: '応募方法',
          value: 'お電話または上記メールフォームからご連絡ください。',
